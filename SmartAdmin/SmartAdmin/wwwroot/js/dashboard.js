function ChartsDisplay(jsonData) {
    'use strict'
    // Access the properties of the results object
    var results = JSON.parse(jsonData);
    var total = results.total;
    var completed = results.completed;
    var inProgress = results.inProgress;
    var pending = results.pending;
    var rejected = results.rejected;
    var cancelled = results.cancelled;
    var Jan = results.Jan;
    var Feb = results.Feb;
    var Mar = results.Mar;
    var Apr = results.Apr;
    ...
    if ($('#progressbar1').length) {
        var CompletedSales = (completed / total)  ;
        ...
        var bar = new ProgressBar.Circle(progressbar1, {
            ...
            step: function (state, circle) {
                ...
                var value = Math.round(CompletedSales * 100);
        ...
        bar.animate(CompletedSales); // Animate with the initial value of CompletedSales
    ...
    if ($('#monthly-sales-chart').length) {
        ...
        // Assuming you have an array of sales data for each month
        var salesData = [Jan, Feb, Mar, Apr, May, Jun, Jul, Aug, Sep, Oct, Nov, Dec];

        // Find the maximum value in the salesData array
        var maxSales = Math.max(...salesData)+10;
                ...
                scales: {
                    ...
                    yAxes: [{
                        ...
                        ticks: {
                            ...
                            fontSize: 10,
                            min: 0,
                            max: maxSales   // Use the calculated maximum value
                        }
                    }]
                }
            }
